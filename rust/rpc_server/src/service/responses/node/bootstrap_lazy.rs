...
pub async fn bootstrap_lazy(node: Arc<Node>, hash: BlockHash, force: Option<bool>, id: Option<String>) -> String {
    ...
    let key_inserted = node.bootstrap_initiator.bootstrap_lazy(hash.into(), force, bootstrap_id);
