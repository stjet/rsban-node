use super::{ChannelId, ChannelTcp, DeadChannelCleanupStep, DeadChannelCleanupTarget, FairQueue};
...
impl InboundMessageQueue {
    ...
    pub fn put(&self, message: Message, channel: Arc<ChannelTcp>) -> bool {
    ...
    ) -> VecDeque<(ChannelId, (Message, Arc<ChannelTcp>))> {
...
struct State {
    queue: FairQueue<ChannelId, (Message, Arc<ChannelTcp>)>,
    stopped: bool,
}
...
mod tests {
    ...
    fn put_and_get_one_message() {
        ...
        manager.put(Message::BulkPush, Arc::new(ChannelTcp::new_null()));
