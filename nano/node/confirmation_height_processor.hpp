...
{
public:
	confirmation_height_processor (nano::ledger &, nano::stat & stats_a, nano::write_database_queue &, std::chrono::milliseconds, nano::logging const &, std::shared_ptr<nano::logger_mt> &, boost::latch & initialized_latch, confirmation_height_mode = confirmation_height_mode::automatic);
