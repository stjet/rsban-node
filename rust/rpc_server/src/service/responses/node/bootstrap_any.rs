...
pub async fn bootstrap_any(node: Arc<Node>, force: Option<bool>, id: Option<String>, account: Option<Account>) -> String {
    if node.flags.disable_legacy_bootstrap {
        return to_string_pretty(&ErrorDto::new("Bootstrap legacy is disabled".to_string())).unwrap();
    }
