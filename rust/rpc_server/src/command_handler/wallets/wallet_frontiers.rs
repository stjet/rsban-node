...
use rsnano_rpc_messages::{FrontiersDto, WalletRpcMessage};
use std::collections::HashMap;

impl RpcCommandHandler {
    pub(crate) fn wallet_frontiers(&self, args: WalletRpcMessage) -> anyhow::Result<FrontiersDto> {
