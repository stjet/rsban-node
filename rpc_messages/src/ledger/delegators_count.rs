...
mod tests {
    ...
    fn serialize_delegators_count_command() {
        ...
        let expected = json!({"action": "delegators_count", "account": "ban_1111111111111111111111111111111111111111111111111111hifc8npp"});
        assert_eq!(serialized, expected);
    }

    #[test]
    fn deserialize_delegators_count_command() {
        let json = r#"{"action": "delegators_count","account": "ban_1111111111111111111111111111111111111111111111111111hifc8npp"}"#;
