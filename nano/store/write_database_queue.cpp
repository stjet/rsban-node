...
nano::store::write_guard nano::store::write_database_queue::wait (nano::store::writer writer)
{
...
bool nano::store::write_database_queue::contains (nano::store::writer writer)
{
	return rsnano::rsn_write_database_queue_contains (handle, static_cast<uint8_t> (writer));
}

bool nano::store::write_database_queue::process (nano::store::writer writer)
{
