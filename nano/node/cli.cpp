...
{
	std::error_code ec;
	flags_a.set_disable_max_peers_per_ip (vm.count ("disable_max_peers_per_ip") > 0);
	flags_a.set_disable_max_peers_per_subnetwork (vm.count ("disable_max_peers_per_subnetwork") > 0);
	flags_a.set_disable_activate_successors (vm.count ("disable_activate_successors") > 0);
	...
	flags_a.set_disable_bootstrap_bulk_pull_server (vm.count ("disable_bootstrap_bulk_pull_server") > 0);
	flags_a.set_disable_bootstrap_bulk_push_client (vm.count ("disable_bootstrap_bulk_push_client") > 0);
	flags_a.set_disable_tcp_realtime (vm.count ("disable_tcp_realtime") > 0);
	flags_a.set_disable_ongoing_telemetry_requests (vm.count ("disable_ongoing_telemetry_requests") > 0);
	flags_a.set_disable_block_processor_republishing (vm.count ("disable_block_processor_republishing") > 0);
	flags_a.set_disable_search_pending (vm.count ("disable_search_pending") > 0);
