...
use crate::{
    ...
    transport::{ChannelMode, MessageProcessor, NetworkExt, Socket, SocketExtensions},
    NetworkParams,
};
...
pub struct ResponseServerImpl {
    ...
    tcp_message_manager: Arc<MessageProcessor>,
...
impl ResponseServerImpl {
    ...
    pub fn new_null() -> Self {
        Self {
            ...
            tcp_message_manager: Arc::new(MessageProcessor::new(1)),
