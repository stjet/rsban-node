...
mod tests {
    ...
    fn serialize_successors_command() {
        ...
        .unwrap();
        let args = ChainArgs::builder(BlockWithCountArgs::new(block_hash, 1)).offset(1).reverse().build();
    ...
    fn deserialize_successors_command() {
        ...
        .unwrap();
        let args = ChainArgs::builder(BlockWithCountArgs::new(expected_block_hash, 1)).offset(1).reverse().build();
