...
impl Logging {
    ...
    pub fn serialize_toml(&self, toml: &mut dyn TomlWriter) -> Result<()>{
        toml.put_bool("ledger", self.ledger_logging_value, "Log ledger related messages.\ntype:bool")?;
        toml.put_bool("ledger_duplicate", self.ledger_duplicate_logging_value, "Log when a duplicate block is attempted inserted into the ledger.\ntype:bool")?;
        toml.put_bool("ledger_rollback", self.election_fork_tally_logging_value, "Log when a block is replaced in the ledger.\ntype:bool")?;
        ...
        toml.put_bool("election_expiration", self.election_expiration_tally_logging_value, "Log election tally on expiration.\ntype:bool")?;
        toml.put_bool("election_fork", self.election_fork_tally_logging_value, "Log election tally when more than one block is seen.\ntype:bool")?;
        toml.put_bool("network", self.network_logging_value, "Log network related messages.\ntype:bool")?;
        toml.put_bool("network_timeout", self.network_timeout_logging_value, "Log TCP timeouts.\ntype:bool")?;
        toml.put_bool("network_message", self.network_message_logging_value, "Log network errors and message details.\ntype:bool")?;
        toml.put_bool("network_publish", self.network_publish_logging_value, "Log publish related network messages.\ntype:bool")?;
        toml.put_bool("network_packet", self.network_packet_logging_value, "Log network packet activity.\ntype:bool")?;
        toml.put_bool("network_keepalive", self.network_keepalive_logging_value, "Log keepalive related messages.\ntype:bool")?;
        toml.put_bool("network_node_id_handshake", self.network_node_id_handshake_logging_value, "Log node-id handshake related messages.\ntype:bool")?;
        toml.put_bool("network_telemetry", self.network_telemetry_logging_value, "Log telemetry related messages.\ntype:bool")?;
        toml.put_bool("network_rejected", self.network_rejected_logging_value, "Log message when a connection is rejected.\ntype:bool")?;
        toml.put_bool("node_lifetime_tracing", self.node_lifetime_tracing_value, "Log node startup and shutdown messages.\ntype:bool")?;
        toml.put_bool("insufficient_work", self.insufficient_work_logging_value, "Log if insufficient work is detected.\ntype:bool")?;
        toml.put_bool("log_ipc", self.log_ipc_value, "Log IPC related activity.\ntype:bool")?;
        toml.put_bool("bulk_pull", self.bulk_pull_logging_value, "Log bulk pull errors and messages.\ntype:bool")?;
        toml.put_bool("work_generation_time", self.work_generation_time_value, "Log work generation timing information.\ntype:bool")?;
        ...
        toml.put_bool("timing", self.timing_logging_value, "Log detailed timing information for various node operations.\ntype:bool")?;
        toml.put_bool("active_update", self.active_update_value, "Log when a block is updated while in active transactions.\ntype:bool")?;
        ...
        toml.put_usize("max_size", self.max_size, "Maximum log file size in bytes.\ntype:uint64")?;
        toml.put_usize("rotation_size", self.rotation_size, "Log file rotation size in character count.\ntype:uint64")?;
        ...
        toml.put_bool("single_line_record", self.single_line_record_value, "Keep log entries on single lines.\ntype:bool")?;
