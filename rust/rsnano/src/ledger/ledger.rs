...
mod tests {
    use crate::{
        core::KeyPair, ledger::ledger_tests::LedgerContext, DEV_CONSTANTS, DEV_GENESIS_ACCOUNT,
    };

    use super::*;

    #[test]
    fn rollback_send_block() {
    ...
    fn rollback_receive() {
        ...
        let send2 = ctx.process_send_from_genesis(txn.as_mut(), &receiver_account, Amount::new(25));
