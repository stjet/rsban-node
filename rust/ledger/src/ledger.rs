...
use rsnano_store_lmdb::{
    LmdbReadTransaction, LmdbStore, LmdbWriteTransaction, RoCursorWrapper, Transaction,
};
...
impl Ledger {
    ...
    pub fn account_info(
        &self,
        transaction: &dyn Transaction<Database = lmdb::Database, RoCursor = RoCursorWrapper>,
        account: &Account,
    ) -> Option<AccountInfo> {
