...
impl NanoRpcClient {
    ...
    pub async fn republish(&self, hash: BlockHash, sources: Option<bool>, destinations: Option<bool>) -> Result<BlocksDto> {
        let cmd = RpcCommand::republish(hash, sources, destinations);
