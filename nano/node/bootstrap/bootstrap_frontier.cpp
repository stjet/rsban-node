...
nano::frontier_req_server::frontier_req_server (std::shared_ptr<nano::node> const & node_a, std::shared_ptr<nano::abstract_bootstrap_server> const & connection_a, std::unique_ptr<nano::frontier_req> request_a) :
	node (node_a),
	connection (connection_a),
