...
impl BulkPullClientExt for Arc<BulkPullClient> {
    ...
    fn received_block(&self, ec: ErrorCode, block: Option<BlockEnum>) {
        ...
        warn!("RECEIVED_BLOCK");
        if ec.is_err() {
            warn!("RECEIVED_BLOCK NETWORK ERROR!");
        ...
        warn!("CALLING PROCESS_BLOCK IN ATTEMPT");
