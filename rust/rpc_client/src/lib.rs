...
impl NanoRpcClient {
    ...
    pub async fn work_generate(&self, hash: BlockHash, use_peers: Option<bool>, difficulty: Option<u64>, multiplier: Option<u64>, account: Option<Account>, version: Option<WorkVersion>, block: Option<JsonBlock>) -> Result<WorkGenerateDto> {
