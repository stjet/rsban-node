...
pub async fn block_hash(block: JsonBlock) -> String {
    ...
    to_string_pretty(&BlockHashRpcMessage::new("hash".to_string(), block_enum.hash())).unwrap()
}
...
mod tests {
    ...
    fn block_hash() {
        ...
        assert_eq!(result.value, BlockHash::decode_hex("D9E4A975D8C4E7FE6F3569B6B60EE19D7C090C5B6E316416DC36F8C90264DF60").unwrap());
